		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
                    ...
                    <br/>
                    <span style="color:#663399";>Selamat Datang, <?php echo $sesi['nama'];?></span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-hover table-bordered" id="mytable" style="margin-top: 10px">
                                ...
                                <?php
                                    $no=1;
                                    $hasil = $proses->tampil_data('tbl_karyawan');
                    ...
                    <?php }else{?>
                        ...
                        <div class="alert alert-info">
                            <h3> Untuk Mengakses Data Karyawan, Silahkan Login Terlebih Dahulu!</h3>
                            <hr/>
